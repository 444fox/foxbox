...
A toolbox for getting photos and videos off camera cards and into an organized library, then culling, deduplicating, shrinking, and color-correcting them (with a special soft spot for scuba photos).
